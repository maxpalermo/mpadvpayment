...
// STEP 3 - Extract the data PayPal IPN has sent us, into local variables 
    ...
    classMpLogger::add('IPN LISTENER');
...
//$fh = fsockopen ('ssl://ipnpb.paypal.com/cgi-bin/webscr', 443, $errno, $errstr, 30);
$fh = fsockopen ('ssl://ipnpb.sandbox.paypal.com/cgi-bin/webscr', 443, $errno, $errstr, 30);
